...
t<-read.csv(paste(path,"Data/Summaries/NMFSspring.csv",sep=""),stringsAsFactors = F)
...
for (num_col in names(t)) {
  ...
  pdf(paste(path, "Results/Figures/Covariates/NMFSspring/", n, ".pdf", sep=""))
  par(mfrow = c(2,3))
...
# 
# path <- "/Users/user/DFO_2017/"
 t<-read.csv(paste(path,"Data/Summaries/Temporal_NMFSspring.csv",sep=""),stringsAsFactors = F)

pdf(paste(path, "Results/Figures/Covariates/NMFSspring/temporal.pdf", sep=""))
par(mfrow = c(3,3))
cols = names(t[,c(2:55)])
for (i in cols) {
...
for (num_col in names(t)) {
  ...
  pdf(paste(path, "Results/Figures/Covariates/NMFSspring/env", n, ".pdf", sep=""))
  par(mfrow = c(3,3))
...
for (num_col in names(t)) {
  ...
  pdf(paste(path, "Results/Figures/Covariates/NMFSspring/env_CDF_", n, ".pdf", sep=""))
  par(mfrow = c(3,3))
  cols = names(f[,c(20:74)])
