...
direct.fun <- "D:/Github/"; dir.ftmp <- direct.fun
...
load(file = "D:/NAS/Projects/GB_time_area_closure_SPERA/Results/Prediction_mesh.RData")
# Here I load results from the models with the full predictive fields.
load(paste0(direct.proj,"Results/Prediction_fields_all_models.RData"))
