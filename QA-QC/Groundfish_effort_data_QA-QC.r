...
effort.by.set <- read.csv("D:/local_backup/Projects/GB_time_area_closure_SPERA/Data/Groundfish/Effort_2003_2016_needs_QAQC.csv",
                               stringsAsFactors = F)
groundfish.GB <- read.csv("D:/local_backup/Projects/GB_time_area_closure_SPERA/Data/Groundfish/Catch_GB_clean.csv",stringsAsFactors = F)
...
write.csv(all.otter.cod.yt.all.sets,"D:/local_backup/Projects/GB_time_area_closure_SPERA/Data/Groundfish/Otter_trawl_catch_and_effort_clean_yt_and_cod.csv")
...
write.csv(all.cod.yt.sets,"D:/local_backup/Projects/GB_time_area_closure_SPERA/Data/Groundfish/groundfish_yt_cod_catch.csv")
