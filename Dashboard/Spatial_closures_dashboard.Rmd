...
if(direct.proj != 'github')load(paste0(direct.proj,"Paper_2_SDMs/data/NEW_pred_and_Random_fields.RData"))
...
if(direct.proj != 'github')load(paste0(direct.proj,"Paper_2_SDMs/data/3_and_5_year_random_fields.RData"))
...
if(direct.proj != 'github')load(paste0(direct.proj,"Paper_2_SDMs/data/10_year_random_fields.RData"))
...
#input <- list(species_pred = 'cod',year_pred = 1996:2000,prob_pred = 0.5,survey_pred = "RV_survey")
