...
-   These results show the time series of core area during spawning on GB in the U.S. and within Canada using the Canadian Offshore Scallop Fishery (COSF) survey domain.
    - *Atlantic Cod* model results shown are from the *Winter* survey, 
    - *Yellowtail Flounder* model results are from the *Spring* survey, 
    - Both stocks use the 5-year random field model for prediction.
...
-   These results show the spatial *core area* predictions during spawning on GB.
    - The points are actual presence (yellow) and absence (grey) results for each survey tow 
    - *Atlantic Cod* model results shown are from the *Winter* survey, 
    - *Yellowtail Flounder* model results are from the *Spring* survey, 
    - Both stocks use the 5-year random field model for prediction.
...
-   These results show the spatial *core area* predictions during spawning on GB.
    - The points are shown as 'residual' or 'prediction' error from the model
    - *Atlantic Cod* model results shown are from the *Winter* survey, 
    - *Yellowtail Flounder* model results are from the *Spring* survey, 
    - Both stocks use the 5-year random field model for prediction.
