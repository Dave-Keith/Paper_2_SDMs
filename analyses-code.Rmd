...
rf.winter.cod <- rand.field.pred$`cod_PA RV_survey`
rf.spring.cod <- rand.field.pred$`cod_PA nmfs-spring_survey`
rf.fall.cod <- rand.field.pred$`cod_PA nmfs-fall_survey`


eras <- factor.2.number(unique(pred.output.pred$`cod_PA RV_survey`$years_5))
n.eras <- length(eras)
mesh.tmp <- st_sf(rep(st_sf(mesh.sf$vertices)$geometry,n.eras), crs = st_crs(mesh.grid))
mesh.tmp$ID <- rf.winter.cod$ID
...
plt.rf.winter.cod <- bp + geom_sf(data = rf.winter.cod  ,aes(fill = mean,colour=mean))+
...
plt.rf.winter.cod.sd <- bp + geom_sf(data = rf.winter.cod  ,aes(fill = sd,colour=sd))+
facet_wrap(~yrs,ncol=6) +
...
eras <- factor.2.number(unique(pred.output.pred$`cod_PA nmfs-spring_survey`$years_5))
n.eras <- length(eras)
mesh.tmp <- st_sf(rep(st_sf(mesh.sf$vertices)$geometry,n.eras), crs = st_crs(mesh.grid))
mesh.tmp$ID <- rf.spring.cod$ID
rf.spring.cod <- merge(mesh.tmp,rf.spring.cod, by = "ID")
rf.spring.cod$era <- NA
...
for(i in 1:n.eras)
{
  count1 <- (i-1)*nrows+1
  count2 <- (i)*nrows
  rf.spring.cod$era[count1:count2] <- eras[i]
}
...
# Facet version of the above NOTE HOW THE YEARS ARE F'd up now...
plt.rf.spring.cod <- bp + geom_sf(data = rf.spring.cod  ,aes(fill = mean,colour=mean))+
facet_wrap(~yrs,ncol=5) +
  coord_sf(datum=32619) + sf + sc  +# theme_map() +
 theme(legend.key.width =hgt,text = element_text(size=16), legend.position="top")
#plt.rf.winter.cod

plt.rf.spring.cod.sd <- bp + geom_sf(data = rf.spring.cod  ,aes(fill = sd,colour=sd))+
facet_wrap(~yrs,ncol=5) +
  coord_sf(datum=32619) + sf.sd + sc.sd  +# theme_map() +
 theme(legend.key.width =hgt,text = element_text(size=16), legend.position="top")
...
eras <- factor.2.number(unique(pred.output.pred$`cod_PA nmfs-fall_survey`$years_5))
n.eras <- length(eras)
mesh.tmp <- st_sf(rep(st_sf(mesh.sf$vertices)$geometry,n.eras), crs = st_crs(mesh.grid))
mesh.tmp$ID <- rf.fall.cod$ID
...
for(i in 1:n.eras)
{
  count1 <- (i-1)*nrows+1
  count2 <- (i)*nrows
  rf.fall.cod$era[count1:count2] <- eras[i]
}
for(n in min(eras):max(eras))
{
...
# Facet version of the above NOTE HOW THE YEARS ARE F'd up now...
plt.rf.fall.cod <- bp + geom_sf(data = rf.fall.cod  ,aes(fill = mean,colour=mean))+
facet_wrap(~yrs,ncol=5) +
  coord_sf(datum=32619) + sf + sc  +# theme_map() +
 theme(legend.key.width =hgt,text = element_text(size=16), legend.position="top")
#plt.rf.winter.cod

plt.rf.fall.cod.sd <- bp + geom_sf(data = rf.fall.cod  ,aes(fill = mean,colour=mean))+
  facet_wrap(~yrs,ncol=5) +
  coord_sf(datum=32619) + sf.sd + sc.sd  +# theme_map() +
 theme(legend.key.width =hgt,text = element_text(size=16), legend.position="top")
...
rf.winter.yt <- rand.field.pred$`yt_PA RV_survey`
rf.spring.yt <- rand.field.pred$`yt_PA nmfs-spring_survey`
rf.fall.yt <- rand.field.pred$`yt_PA nmfs-fall_survey`


eras <- factor.2.number(unique(pred.output.pred$`yt_PA RV_survey`$years_3))
n.eras <- length(eras)
mesh.tmp <- st_sf(rep(st_sf(mesh.sf$vertices)$geometry,n.eras), crs = st_crs(mesh.grid))
mesh.tmp$ID <- rf.winter.yt$ID
...
for(i in 1:n.eras)
{
  count1 <- (i-1)*nrows+1
  count2 <- (i)*nrows
  rf.winter.yt$era[count1:count2] <- eras[i]
}
...
# Facet version of the above NOTE HOW THE YEARS ARE F'd up now...
plt.rf.winter.yt <- bp + geom_sf(data = rf.winter.yt  ,aes(fill = mean,colour=mean))+
  facet_wrap(~yrs,ncol=5) +
  coord_sf(datum=32619) + sf + sc  +# theme_map() +
 theme(legend.key.width =hgt,text = element_text(size=16), legend.position="top")
#plt.rf.winter.yt

plt.rf.winter.yt.sd <- bp + geom_sf(data = rf.winter.yt  ,aes(fill = sd,colour=sd))+
  facet_wrap(~yrs,ncol=5) +
...
eras <- factor.2.number(unique(pred.output.pred$`yt_PA nmfs-spring_survey`$years_3))
n.eras <- length(eras)
mesh.tmp <- st_sf(rep(st_sf(mesh.sf$vertices)$geometry,n.eras), crs = st_crs(mesh.grid))
mesh.tmp$ID <- rf.spring.yt$ID
...
for(i in 1:n.eras)
{
  count1 <- (i-1)*nrows+1
  count2 <- (i)*nrows
  rf.spring.yt$era[count1:count2] <- eras[i]
}
...
# Facet version of the above NOTE HOW THE YEARS ARE F'd up now...
plt.rf.spring.yt <- bp + geom_sf(data = rf.spring.yt  ,aes(fill = mean,colour=mean))+
  facet_wrap(~yrs,ncol=6) +
  coord_sf(datum=32619) + sf + sc  +# theme_map() +
 theme(legend.key.width =hgt,text = element_text(size=16), legend.position="top")
#plt.rf.spring.yt

plt.rf.spring.yt.sd <- bp + geom_sf(data = rf.spring.yt  ,aes(fill = sd,colour=sd))+
  facet_wrap(~yrs,ncol=6) +
  coord_sf(datum=32619) + sf.sd + sc.sd  +# theme_map() +
 theme(legend.key.width =hgt,text = element_text(size=16), legend.position="top")
#plt.rf.spring.yt.sd
...
eras <- factor.2.number(unique(pred.output.pred$`yt_PA nmfs-fall_survey`$years_5))
n.eras <- length(eras)
mesh.tmp <- st_sf(rep(st_sf(mesh.sf$vertices)$geometry,n.eras), crs = st_crs(mesh.grid))
mesh.tmp$ID <- rf.fall.yt$ID
...
for(i in 1:n.eras)
{
  count1 <- (i-1)*nrows+1
  count2 <- (i)*nrows
  rf.fall.yt$era[count1:count2] <- eras[i]
} # end for(i in 1:n.eras)
...
# Facet version of the above NOTE HOW THE YEARS ARE F'd up now...
plt.rf.fall.yt <- bp + geom_sf(data = rf.fall.yt  ,aes(fill = mean,colour=mean))+
  facet_wrap(~yrs,ncol=6) +
  coord_sf(datum=32619) + sf + sc  +# theme_map() +
 theme(legend.key.width =hgt,text = element_text(size=16), legend.position="top")
#plt.rf.fall.yt

plt.rf.fall.yt.sd <- bp + geom_sf(data = rf.fall.yt  ,aes(fill = sd,colour=sd))+
  facet_wrap(~yrs,ncol=6) +
  coord_sf(datum=32619) + sf.sd + sc.sd  +# theme_map() +
 theme(legend.key.width =hgt,text = element_text(size=16), legend.position="top")
#plt.rf.fall.yt.sd
