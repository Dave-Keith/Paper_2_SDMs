...
<!-- ```{r word-vs-pdf-and-language, cache=F} -->
...
cap <- "Environmental variables used in the analysis. Variables in \\textbf{bold} were retained after Variance Inflation Factor (VIF) analyses and were included in the linear models. Variables in \\textbf{italics} were used for the Princpal Component Analysis (PCA)"
if(french) 
{  
...
# }
# 
# if(length(grep("word", names(meta))))
# {
