...
direct.proj <- "D:/Projects/GB_time_area_closure_SPERA/"; direct.tmp <- direct.proj
```
...
<!-- ```{r Overview, echo=FALSE,out.width="100%",dpi=200,fig.cap = "Inset shows magnification of George's Bank a showing the outline (in grey) of the primary scallop fishing area and hatched squares show all the cells that have been closed in at least one year since 2006 (some were only closed one year, others closed multiple years). Closures for cod are February-March, 2006-2018, and for yellowtail flounder are June, 2007-2018"}  -->
