...
Sustainable management of marine fisheries has been recognized as a critical challenge facing society in the 21^st^ century [@cbdAichiBiodiversityTargets2018]. The challenges facing sustainable fisheries management are multifaceted and include complex socio-economic, political, and scientific interactions (CITE). Management of fisheries often focuses on relatively large regions which were delineated as a result of political or geographic considerations rather than biological or ecological rationale.  Within these regions the stocks are often treated as homogeneous entities despite known or assumed spatial heterogeneity in the processes that drive the population dynamics of the stock (CITE).

One of the long-standing challenges in fisheries science has been to account for the spatial and temporal heterogeneity in these processes d (CITE).  From the early days of fisheries science it was recognized that an inability to fully account for spatial processes was potentially a serious issues to surmount (CITE). Many of the traditional fisheries methods developed, and still currently used to assess fisheries, require strong assumptions about the underlying spatial processes; during the development of these methods these assumptions were often identified as potentially problematic (CITE Ricker, BH, and maybe Carl and Ray's book). 
